...
* <b><kbd>{color:yellow}Monitoramento ambiental:</b><kbd>{/color} O geoprocessamento de imagens pode ser usado para monitorar o meio ambiente, como a qualidade da água, a cobertura vegetal ou a ocorrência de desastres naturais.
